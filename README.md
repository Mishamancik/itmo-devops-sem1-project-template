...
7. В конце необходимо остановить работу приложения:
...
В POST-запросе нужно передавать ZIP-архив с CSV-файлом. Сервер вернёт JSON с количеством товаров, количеством категорий и общей суммой цен, а содержимое файла будет добавлено в базу данных.
...
Для GET-запроса входные данные не нужны. Он вернет ZIP-архив с CSV-файлом, в котором содержатся все записи БД на текущий момент.
